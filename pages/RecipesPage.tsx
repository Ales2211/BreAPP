...
const RecipeCard: React.FC<{ recipe: Recipe, recipeCost: number, onEdit: () => void, onDelete: () => void, t: (key: string) => string }> = ({ recipe, recipeCost, onEdit, onDelete, t }) => {
...
const RecipesListPage: React.FC<RecipesListPageProps> = ({ recipes, masterItems, onNewRecipe, onEditRecipe, onDeleteRecipe }) => {
                ...
                <div className="flex-1 overflow-y-auto space-y-4 pr-2">
                    {recipes.map(recipe => (
                        <RecipeCard 
                            ...
                            onDelete={() => onDeleteRecipe(recipe.id)} t={t} />
                    ))}
                </div>
            ) : (
